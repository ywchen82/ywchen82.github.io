...
<li>
  ...
  <div class="paper-authors"><strong>Yi-Wen Chen</strong>, Co-author One, and Co-author Two
    &nbsp;<a href="https://SSRN_LINK" target="_blank" rel="noopener">[Paper]</a>
  </div>
...
```html
<tr><td>Course Name</td><td>Role</td><td>Term</td></tr>
```
